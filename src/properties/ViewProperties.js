...
useEffect(() => {
  axios.get(`http://localhost:81/api/Property/get-property/${id}`)
    ...
    <div className='py-10'>
      <div className='bg-slate-100 py-10 px-10 mx-auto rounded-md shadow-md'>
        ...
        <div className='flex flex-row gap-10 items-center justify-center'>
          <div className='w-[400px] shadow-lg rounded-bl-[50px]'>
          ...
          <div className='flex flex-col gap-5'>
            ...
            <div className='flex flex-row gap-2'>
              <Link to={`/editproperties/${data.id}`} className='px-4 py-2 rounded-md bg-green-500 text-white font-bold'>Edit</Link>
              <Link to={'/properties'} className='px-4 py-2 rounded-md bg-red-500 text-white font-bold'>Back</Link>
            </div>
          </div>
        </div>
      </div>
